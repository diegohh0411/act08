...
class ContentViewModel: ObservableObject {
    ...
    func createContent(name: String, details: String, url: String, resourceType: String, transcript: String) async {
        // The content_id is generated by the server, so we can pass a dummy one.
        let newContent = Content(content_id: 0, name: name, details: details, url: url, resourceType: resourceType, transcript: transcript)
        do {
